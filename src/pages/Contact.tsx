...
const Contact = () => {
  ...
  const [form, setForm] = useState({ name: "", email: "", phone: "", company: "", gst: "", message: "" });

  useEffect(() => {
    if (searchParams.get("type") === "b2b") {
      setInquiryType("b2b");
      setTimeout(() => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setForm({ name: "", email: "", phone: "", company: "", gst: "", message: "" });
  };
  ...
  return (
    <main className="py-12 md:py-20">
      <div className="container">
        ...
        <div id="b2b-section" className="mx-auto mt-12 grid max-w-4xl gap-12 md:grid-cols-2">
          {/* Contact Info */}
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {inquiryType === "b2b" ? "care@nanheram.com" : "care@nanheram.com"}
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">+91 7869462082</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">BEDAR WILLS INDIA PVT. LTD.
Near Lakshmi Narayan Mandir
Dabra, District Gwalior
Madhya Pradesh – 475110, India</p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 rounded-lg border border-border bg-card p-6 shadow-sm md:p-8">
            ...
            {inquiryType === "b2b" && (
              <>
                ...
                <div>
                  <label className="mb-1.5 block text-sm font-medium text-foreground">GST No. <span className="text-muted-foreground">(Optional)</span></label>
                  <Input
                    value={form.gst}
